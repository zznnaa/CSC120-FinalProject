...
public class Game {
    ...
    public static void main(String[] args) {
            ...
            System.out.println("Congratualations! As a student at the Imperial Academy of War, The Imperial Crown has selected YOU to serve in Her Majesty's Army, First Cohort. \n\nYou must unite soldiers from the Far Woods, Back Lakes and Imperium City under your command in order to lead them to victory against enemy forces. The General of War, Second to Her Imperial Majesty has charged you with a simple command: \"FAILURE IS NOT AN OPTION\" \n\n(NOTE: If at any point you 're unsure of what to do, seek HELP. Even the best warlords need help from time to time.)");
